    ...
    <main className="mx-auto max-w-3xl py-8">
      ...
      <article className="prose prose-zinc dark:prose-invert prose-headings:tracking-tight prose-a:text-zinc-900 dark:prose-a:text-zinc-100 mt-6 max-w-none">
        ...
        <p className="lead text-zinc-600 dark:text-zinc-400">
          ...
          searched “Dropover for Windows”, Holdem is the answer: the same
          shake-to-summon shelf workflow, rebuilt free and open-source for
          Windows 10 and 11.
        </p>
        ...
        <div className="not-prose rounded-xl border border-zinc-200 bg-zinc-50 p-4 text-sm dark:border-zinc-800 dark:bg-zinc-900">
          ...
          shake, stash, navigate, drop. No trial countdown, no 3-second wait, no
          $6.99 unlock.
        </div>
            ...
            <tbody className="divide-y divide-zinc-200 dark:divide-zinc-800">
              <tr>
                ...
                <td className="px-4 py-3">
                  macOS 13+ only, Mac App Store exclusive
                </td>
              </tr>
              <tr>
                ...
                <td className="px-4 py-3">
                  Free download; Dropover Pro $6.99 one-time in-app purchase
                </td>
              </tr>
              <tr>
                <td className="px-4 py-3 font-medium">Free-tier limits</td>
                <td className="px-4 py-3">
                  None — no timers, no locked features
                </td>
                <td className="px-4 py-3">
                  14-day full trial, then a 3-second wait before interacting
                  with the shelf
                </td>
              </tr>
              <tr>
                ...
                <td className="px-4 py-3">
                  Pointer shake, customizable shortcut, menu bar, MacBook notch,
                  Command Bar
                </td>
              </tr>
              <tr>
                ...
                <td className="px-4 py-3">
                  Files, folders, documents, images, URLs, text snippets,
                  browser images
                </td>
              </tr>
              <tr>
                ...
                <td className="px-4 py-3">
                  Single floating shelf, draggable, auto-hides when empty
                </td>
                <td className="px-4 py-3">
                  Pinned shelves, custom titles, color-coding, dockable shelves,
                  detail view, rename/reorder on shelf
                </td>
              </tr>
              <tr>
                ...
                <td className="px-4 py-3">
                  One-click uploads: free anonymous Dropover Cloud + iCloud
                  Drive, AWS S3, Google Drive, OneDrive, Imgur, Dropbox; macOS
                  Share menu (Mail, Messages, AirDrop)
                </td>
              </tr>
              <tr>
                ...
                <td className="px-4 py-3">
                  Instant Actions, custom actions &amp; scripts (AppleScript,
                  Automator, UNIX), folder monitoring, screenshot shelves,
              ...
              <tr>
                ...
                <td className="px-4 py-3">
                  Tauri + Rust — small installer, quiet tray app, auto-launch
                </td>
                <td className="px-4 py-3">
                  Native Mac app, frequently updated (5.x line)
                </td>
              </tr>
            </tbody>
          </table>
        ...
        <p>
          This comparison is unusual because the two apps do not compete on the
          same computers. Dropover requires macOS 13 or later and is distributed
          only via the Mac App Store — its own FAQ confirms there is no other
          way to get it. Holdem runs on Windows 10 and 11 (x64) as a small
          Tauri/Rust tray app. So the practical advice is simple: Mac users
          should evaluate Dropover (and Yoink); Windows users choosing between
          shelves are really choosing between Holdem, Dropshelf, and DropPoint —
          see our <Link href="/vs">full comparison index</Link>.
        </p>

        <h2>Pricing: $0 forever vs $6.99 once</h2>
        <p>
          Dropover follows the classic indie-Mac model: the download is free and
          includes a fully functional 14-day trial. After the trial expires you
          are not charged — the app keeps working but imposes a 3-second wait
          before you can interact with the shelf. Removing it costs $6.99 as a
          one-time in-app purchase (per its Mac App Store listing; verify the
          current price before buying). That is fair pricing for a mature app —
          but it is still a paywall on the core interaction. Holdem has no
          trial, no timer, and no paid tier at all: the MIT-licensed code is on{' '}
          <a
          ...
          , and every feature ships to every user. See{' '}
          <Link href="/pricing">pricing</Link> for the full price table.
        </p>

        <h2>Trigger and shelf UX</h2>
        <p>
          Both apps share the signature gesture: shake the pointer while
          dragging and a shelf pops up. Dropover layers on more entry points — a
          customizable keyboard shortcut, a menu-bar control, dropping onto the
          MacBook notch, Control Center controls, and a Command Bar — plus shelf
          furniture Holdem deliberately skips: pinned shelves with custom
          titles, color-coding, docking to screen edges, and a detail view where
          you can preview, rename, and reorder stashed files. Holdem does one
          thing: the shelf appears exactly where your cursor is, you drop files
          in, you navigate anywhere without holding the mouse button, you drag
          them out, and the shelf auto-hides. If you want a shelf that doubles
          as a workspace, Dropover is richer. If you want the fastest possible
          stash-and-go on Windows, Holdem&apos;s minimalism is the point.
        </p>

        <h2>Content, sharing, and automation</h2>
        <p>
          Dropover handles anything draggable on macOS — files, folders, images,
          links, text — and then lets you <em>do things</em> with the stash:
          share via AirDrop/Mail/Messages, resize images, extract text, zip
          archives, run Instant Actions, fire custom scripts, watch folders, and
          upload to seven cloud services including its own free anonymous
          Dropover Cloud. Holdem covers files, folders, and web images dragged
          from the browser; URL and text drops are roadmap items, and there is
          no cloud, sharing, or scripting layer — by design it is a local-only
          utility with no account and no network calls. Choose based on whether
          your shelf is a transit lounge (Holdem) or a workbench (Dropover).
        </p>
        ...
        <ul>
          <li>
            ...
            — triggers, content, actions, cloud integrations
          </li>
          <li>
            <a
              href="https://dropoverapp.com/faq"
              target="_blank"
              rel="noopener noreferrer"
            >
              Dropover FAQ
            </a>{' '}
            — 14-day trial, 3-second wait, Mac App Store exclusivity
          </li>
          <li>
            <a
              ...
              rel="noopener noreferrer"
            >
              Dropover on the Mac App Store
            </a>{' '}
            — $6.99 Pro, macOS 13+ requirement
          </li>
        </ul>
