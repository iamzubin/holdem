...
const COMPARISONS = [
  {
    ...
    blurb: 'Dropover is Mac-only ($6.99 Pro). Holdem is the free Windows equivalent — full comparison.',
  },
  {
    href: '/vs/yoink',
    title: 'Holdem vs Yoink',
    blurb: 'Yoink is Mac-only ($8.99). Holdem brings the shelf workflow to Windows, free & open-source.',
  },
  {
    href: '/vs/dropshelf',
    title: 'Holdem vs Dropshelf',
    blurb: 'The best free Dropshelf alternative — no 3-second wait, 100% open source.',
  },
  {
    href: '/vs/droppoint',
    title: 'Holdem vs DropPoint',
    blurb: 'Tauri/Rust vs Electron — clean, minimal vs dated & clunky. Modern upgrade.',
  },
]
